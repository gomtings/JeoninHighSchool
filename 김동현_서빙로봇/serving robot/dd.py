import os
os.environ["QT_QPA_PLATFORM_PLUGIN_PATH"] = r"C:/Users/김동현/AppData/Local/Programs/Python/Python311/Lib/site-packages/PyQt5/Qt5/plugins"
# 위 경로는 사용자의 PyQt5 설치 경로와 일치시켜야 합니다. 본인 환경의 plugins 폴더 경로를 꼭 확인하세요.
...
class Form(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle('PyQt5 PID 시뮬레이터')
        self.initUi()
