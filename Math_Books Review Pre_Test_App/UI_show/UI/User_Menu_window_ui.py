...
class Ui_User_Menu_window(object):
    def setupUi(self, User_Menu_window):
        ...
        User_Menu_window.resize(573, 322)
        ...
        self.closed.setGeometry(QRect(120, 220, 331, 71))
        self.closed.setFont(font)
        self.note = QPushButton(User_Menu_window)
        self.note.setObjectName(u"note")
        self.note.setGeometry(QRect(120, 150, 331, 71))
        self.note.setFont(font)
        self.info = QLabel(User_Menu_window)
        self.info.setObjectName(u"info")
        self.info.setGeometry(QRect(350, 300, 221, 21))
        font1 = QFont()
...
"")
        ...
        self.version.setGeometry(QRect(0, 300, 351, 21))
...
"")
    ...
    def retranslateUi(self, User_Menu_window):
        ...
        self.note.setText(QCoreApplication.translate("User_Menu_window", u"\ub2e8\uc5b4\uc7a5", None))
