...
def mapping(xy_resolution, ang, dist, is_show = False):
    ...
    np.savetxt('c:/Users/User/OneDrive/바탕 화면/coding/AutoServingRobot/Software/main/mapping.txt', occupancy_map, fmt='%g', delimiter='\t')

    return occupancy_map, center_x, center_y

if __name__ == '__main__':
    ang, dist = file_read('c:/Users/User/OneDrive/바탕 화면/coding/AutoServingRobot/Software/1/lidar.csv')
